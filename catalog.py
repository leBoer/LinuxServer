...
engine = create_engine('postgresql://catalog:123password@localhost/catalog',
                       encoding='utf8')
...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/app/LinuxServer/fb_client_secrets.json', 'r').read())['web']['app_id']
    app_secret = json.loads(open('/var/www/app/LinuxServer/fb_client_secrets.json', 'r').read())['web']['app_secret']
