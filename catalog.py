...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/app/app/fb_client_secrets.json', 'r').read())['web']['app_id']
    app_secret = json.loads(open('/var/www/app/app/fb_client_secrets.json', 'r').read())['web']['app_secret']
